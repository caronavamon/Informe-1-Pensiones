...
Balance_Fiscal_L %>%
  ...
  labs(
    ...
    y = 
      "Balance Fiscal",
    title = 
      "Evolución del Balance Fiscal mensual en Costa Rica",
    subtitle =
      "2022-2023") +
  theme_minimal() +
    theme(
...
Gracias a este observar se puede que en lo que respecta a gastos primarios Costa Rica se ha mantenido en la mayoría del tiempo por debajo de los ingresos totales lo cual según @hacienda2022
