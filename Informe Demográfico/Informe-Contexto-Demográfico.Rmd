...
ggsave("piramide_plot.svg", plot = piramide_plot)
```
...
ggsave("pob_porc_plot.svg", plot = pob_porc_plot, width = 10, height = 6, units = "in")
...
ggsave("plot2.svg", plot = plot2, width = 10, height = 6, units = "in")
```
...
ggsave("plot7.svg", plot = plot7,width = 10, height = 6, units = "in")
```
...
ggsave("plot8.svg", plot = plot8, width = 10, height = 6, units = "in")
```
...
ggsave("plot9.svg", plot = plot9, width = 10, height = 6, units = "in")
```
...
ggsave("plot10.svg", plot = plot10, width = 10, height = 6, units = "in")
```
