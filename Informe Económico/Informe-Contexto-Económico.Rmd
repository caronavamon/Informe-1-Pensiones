...
ggsave("Tasas_experimentadas_plot.pdf", plot = Tasas_experimentadas_plot, width = 10, height = 6, units = "in")
```
...
plot3 <- ggplot(PIB, aes(x = Trimestre, y = `Producto Interno Bruto a precios de mercado`)) +
  ...
  labs(x = "Trimestre", y = "Producto Interno Bruto") +
  theme_cowplot() +
    theme(legend.position = "bottom",
        plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5),
...
plot4 <- ggplot(PIB, aes(x = Trimestre, y = `Tasa de Variación Interanual`)) +
  ...
  labs(x = "Trimestre", y = "Tasa de Variación Interanual (%)") +
  theme_cowplot() + 
  theme(legend.position = "bottom",
        plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5),
...
ggsave("plot7.pdf", plot = plot5, width = 10, height = 6, units = "in")
```
