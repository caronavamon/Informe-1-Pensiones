...
ggsave("Graf1.pdf", plot = Graf1, width = 10, height = 6, units = "in")
```
...
ggsave("Graf2.pdf", plot = Graf2, width = 10, height = 6, units = "in")
```
...
ggsave("Graf3.pdf", plot = Graf3, width = 10, height = 6, units = "in")
```
...
ggsave("Graf4.pdf", plot = Graf4, width = 10, height = 6, units = "in")
```
...
ggsave("Graf5.pdf", plot = Graf5, width = 10, height = 6, units = "in")
```
...
ggsave("Graf6.pdf", plot = Graf6, width = 10, height = 6, units = "in")
```
...
Graf7 <- ggplot(conteo_anual, aes(x = Año)) +
  ...
  labs(x = "Fecha", color = "Tipo", y = "Cantidad") +
  theme_cowplot() +
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5),
        plot.caption = element_text(hjust = 0, color = "black", size = 8)) 

ggsave("Graf7.pdf", plot = Graf7, width = 10, height = 6, units = "in")
```
...
Graf8 <-  ggplot(conteo, aes(x = as.numeric(año), y = cantidad_personas, color = COD_TIPO_PENSION)) +
  geom_line() +
  labs(x = " Año de inicio de pago de la pensión",
...
ggsave("Graf8.pdf", plot = Graf8, width = 10, height = 6, units = "in")
```
