...
Graf1 <- rbind(
  ...
  labs(
    title =
      "Gráfico 1: Pirámide Poblacional del Régimen",
    subtitle =
...
ggsave("Graf1.svg", plot = Graf1, width = 10, height = 6, units = "in")
```
...
ggsave("Graf2.svg", plot = Graf2, width = 10, height = 6, units = "in")
```
...
ggsave("Graf3.svg", plot = Graf3, width = 10, height = 6, units = "in")
```
...
ggsave("Graf4.svg", plot = Graf4, width = 10, height = 6, units = "in")
```
...
ggsave("Graf5.svg", plot = Graf5, width = 10, height = 6, units = "in")
```
...
ggsave("Graf6.svg", plot = Graf6, width = 10, height = 6, units = "in")
```
...
ggsave("Graf7.svg", plot = Graf7, width = 10, height = 6, units = "in")
```
...
ggsave("Graf8.svg", plot = Graf8, width = 10, height = 6, units = "in")
```
