...
Además, se proyecta una desaceleración en el Producto Interno Bruto hasta alcanzar el 4% anual en el 2024 y 2025 en vista de que, exista una demanda interna que estimule la economía dada por la inversión y el consumo de los hogares costarricenses. Aunado a esto, el crecimiento de la demana externa se espera que continúe disminuyendo por causa de la desaceleración en la actividad económica de los principales socios comerciales del país. 
...
ggplot(variaciones_largas, aes(x = Fecha, y = Variación, fill = Tipo)) +
  ...
  labs(title = "Variaciones Interanuales del Índice de Salario Mínimo Nominal vs Real en Costa Rica",subtitle = "2022-2023", x = "Fecha", y = "Variación (%)") +
  theme_minimal() +
  theme(legend.position = "bottom",
        plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5),
