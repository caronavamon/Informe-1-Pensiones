...
Activo
ggsave("Activo.pdf", plot = Activo, width = 10, height = 6, units = "in")
```
...
ggsave("graf_sector.pdf", plot = graf_sector, width = 10, height = 6, units = "in")
```
...
ggsave("graf_plazo.pdf", plot = graf_plazo, width = 10, height = 6, units = "in")
```
...
ggsave("graf_moneda.pdf", plot = graf_moneda, width = 10, height = 6, units = "in")
```
